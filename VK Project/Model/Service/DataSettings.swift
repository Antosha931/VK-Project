...
//
//        let globalGroupOne = Groups(name: "FunGroup Ronaldo", avatar: UIImage(named: "1_3")!, description: nil)
//        resultArray.append(globalGroupOne)
//
//        let globalGroupTwo = Groups(name: "FunGroup Beckham", avatar: UIImage(named: "2_2")!, description: nil)
//        resultArray.append(globalGroupTwo)
//
//        let globalGroupThree = Groups(name: "FunGroup Messi", avatar: UIImage(named: "4_4")!, description: nil)
//        resultArray.append(globalGroupThree)
//
//        let globalGroupFour = Groups(name: "FunGroup Ronaldinho", avatar: UIImage(named: "3_3")!, description: nil)
